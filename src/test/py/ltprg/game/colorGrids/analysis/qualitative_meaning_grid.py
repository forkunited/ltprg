...
COLORS_PER_DIM=20 # Number of values per dimensions H x S of color to compute meanings over
COLOR_IMG_WIDTH=140
...
utt_tokens = [["#start#", "green", "top", "right", "#end#"], \
              ["#start#", "green", "top", "#end#"], \
              ["#start#", "green", "bottom", "right", "#end#"], \
              ["#start#", "middle", "is", "green", "#end#"], \
              ["#start#", "bottom", "left", "is", "bright", "green", "#end#"], \
              ["#start#", "green", "in", "the", "bottom", "right", "corner", "#end#"]]
#              ["#start#", "blue", "top", "right", "#end#"], \
#              ["#start#", "red", "bottom", "left", "#end#"], \
#              ["#start#", "green", "bottom", "#end#"], \
#              ["#start#", "blue", "top", "left", "#end#"], \
#              ["#start#", "green", "middle", "left", "#end#"], \
#              ["#start#", "green", "middle", "#end#"], \
#              ["#start#", "top", "right", "is", "blue", "#end#"], \
#              ["#start#", "bottom", "left", "is", "red", "#end#"], \
#              ["#start#", "bottom", "green", "#end#"], \
#              ["#start#", "top", "left", "is", "blue", "#end#"], \
#              ["#start#", "middle", "left", "is", "green", "#end#"], \
#              ["#start#", "middle", "green", "#end#"], \
#              ["#start#", "middle", "blue", "and", "top", "left", "red", "#end#"]]
...
colors = construct_grid_space(n_per_dim=COLORS_PER_DIM, standardized=True)
...
# HACK to make grid model take single colors with positions
meaning_fn._world_input_size = 12
other_meaning_fn._world_input_size = 12
...
def make_img(mng):
    mng = mng.contiguous().view(9,COLORS_PER_DIM,COLORS_PER_DIM).cpu().numpy()
    meaning_reshaped = torch.zeros(3*COLORS_PER_DIM, 3*COLORS_PER_DIM).numpy()
    for row in range(3):
        for col in range(3):
            meaning_reshaped[row*COLORS_PER_DIM:((row+1)*COLORS_PER_DIM),col*COLORS_PER_DIM:((col+1)*COLORS_PER_DIM)] = mng[row*3+col]
