...
export MODEL_CONFIG_FILE=${ROOT_DIR}/config/game/colorGrids/model/s0/linear_cgmerged.json
...
do
    ...
    export JOB_ID=s0_onlycolor_${TRAIN_SIZE}
    export LEARN_CONFIG_FILE=${ROOT_DIR}/config/game/colorGrids/learn/s/cgmerged_src_color3_data.json
...
export JOB_ID=s0_onlycolor_full
